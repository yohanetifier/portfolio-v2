...
export const metadata: Metadata = {
  title: 'Works',
  description: 'Explore the creative works and projects by Yohan Etifier. A collection of professional design and development projects showcasing innovative solutions and artistic vision.',
  openGraph: {
